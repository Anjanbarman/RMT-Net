...
urlpatterns = [
    ...
    url(r'^Prediction_Breast_Cancer_Detection_Type/$', remoteuser.Prediction_Breast_Cancer_Detection_Type, name="Prediction_Breast_Cancer_Detection_Type"),
    ...
    url(r'^Find_Predicted_Breast_Cancer_Type_Ratio/$', serviceprovider.Find_Predicted_Breast_Cancer_Type_Ratio, name="Find_Predicted_Breast_Cancer_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Predicted_Breast_Cancer_Detection_Type/$', serviceprovider.View_Predicted_Breast_Cancer_Detection_Type, name="View_Predicted_Breast_Cancer_Detection_Type"),
